...
buttonNode.addEventListener('click', event => console.log('Button was clicked!'));


// Now I want the click on the button to show or hide the comments section
buttonNode.addEventListener('click', event => document.querySelector('.comments').classList.toggle('hidden'));
